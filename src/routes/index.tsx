...
import { announcements, projects, site } from "@/data/site";
  ...
  return (
    <>
        ...
        <div className="container-pad grid items-center gap-12 py-14 md:grid-cols-2 md:py-24">
          ...
          <div className="relative">
            <div
              ...
              style={{ background: "var(--gradient-lagoon)" }}
            />
            <img
              src={heroImg}
          ...
          {[
            {
              ...
              text: "We design experiences where young people actually learn by doing — and have fun doing it.",
            },
            {
              icon: Globe2,
              title: "Inclusion first",
              text: "We prioritise young people with fewer opportunities and remove practical barriers to mobility.",
            },
            {
              icon: Leaf,
              title: "Climate awareness",
              text: "From Green Voices to local clean-ups, we make climate a youth conversation.",
            },
          ].map(({ icon: Icon, title, text }) => (
            <div key={title} className="card-pop">
              <div
                className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-secondary text-secondary-foreground"
        ...
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-3 font-display text-4xl font-bold md:text-5xl">
              Projects you can join right now
            </h2>
          </div>
      ...
      <section className="container-pad py-16">
        <div className="rounded-3xl border-2 border-foreground p-8 md:p-12" style={{ background: "var(--accent)" }}>
          ...
          <ul className="mt-8 divide-y-2 divide-foreground/20">
            {latest.map((a) => (
              <li key={a.slug} className="flex flex-col gap-2 py-5 md:flex-row md:items-center md:justify-between">
                <div>
      ...
      <section className="container-pad py-20">
        <div
          className="rounded-3xl border-2 border-foreground p-10 text-center md:p-16"
          style={{ background: "var(--gradient-lagoon)", boxShadow: "var(--shadow-pop)" }}
        >
          <h2 className="font-display text-4xl font-bold text-primary-foreground md:text-6xl">
            Got a project idea?
          </h2>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-background px-6 py-3 font-display font-semibold text-foreground"
            ...
            <Link
              to="/about"
              className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-background px-6 py-3 font-display font-semibold text-primary-foreground hover:bg-background hover:text-foreground"
            >
              Meet the team
            </Link>
          </div>
